package com.example.mypc.sessionsevenstudentrecord.Database;
...
import com.example.mypc.sessionsevenstudentrecord.Model.StudentData;
import com.example.mypc.sessionsevenstudentrecord.Utils.Constants;
...
public class DBHelper {
    ...
    public List<StudentData> getAllStudents() {
        List<StudentData> students = new LinkedList<StudentData>();

        // select book query
        String query = "SELECT  * FROM " + Constants.STUDENT_RECORD;
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                student.setId((cursor.getString(0)).toString());
