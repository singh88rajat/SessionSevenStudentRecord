package com.example.mypc.sessionsevenstudentrecord.Adapter;
...
import com.example.mypc.sessionsevenstudentrecord.R;
...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(Context context, ArrayList<StudentData> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.userid.setText(data.get(position).getId());
